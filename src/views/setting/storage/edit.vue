        ...
        >
            <el-form ref="formRef" :model="formData" label-width="120px" :rules="formRules">
                <el-form-item label="存储方式" prop="engine">
                    <div>
                        <el-radio v-model="formData.name">{{ getStorageInfo?.name }} </el-radio>
                ...
                <div v-if="formData.engine !== 'local'">
                    ...
                    <template v-if="formData.engine == StorageEnum.ALIYUN">
                        <el-form-item label="策略" prop="config.policy">
                            <el-input
                                v-model="formData.config.policy"
                                placeholder="请输入阿里云策略"
                                type="textarea"
                        ...
                        <el-form-item label="STS节点" prop="config.sts">
                            <div style="width: 350px">
                                <el-input
                                    v-model="formData.config.sts"
                                    placeholder="请输入阿里云STS节点"
                                    maxlength="32"
                                    show-word-limit
                                ></el-input>
                            </div>
                    ...
                    <el-form-item
                        v-if="
                            formData.engine == StorageEnum.QCLOUD ||
                            formData.engine == StorageEnum.ALIYUN
                        "
                        label="区域(region)"
                        prop="region"
                    >
                    ...
                    >
                        <el-input
                            ...
                            clearable
                        />
                        <div class="form-tips">为空则默认根目录</div>
                    </el-form-item>
                </div>
